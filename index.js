                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, handleRequest(railsUrl).then(function (data) { return data; })];
                            case 1:
                                railData = _a.sent();
                                return [2 /*return*/, railData];
                        }
                    });
                }); });
                return [4 /*yield*/, Promise.all(getRailData)];
            case 1:
                railsData = _a.sent();
                return [2 /*return*/, railsData];
        }
    });
}); };
/**
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, handleRequest(railsUrl).then(function (data) { return data.Rails; })];
            case 1:
                railsSchema = _a.sent();
                return [4 /*yield*/, handleRailsData(railsSchema, prams)];
            case 2:
                railsData = _a.sent();
                return [2 /*return*/, railsData];
        }
